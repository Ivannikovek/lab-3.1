...
/*
BinarySearchTree::node* BinarySearchTree::_get_parent_of_searching(BinarySearchTree::node* parent, int value) {
...
/*
void BinarySearchTree::_insert(node* root, int value) {
	if (root == nullptr)
...
/*
void BinarySearchTree::_insert(node*& reference_to_root, int value) {
...
void BinarySearchTree::_insert_in_non_empty(node* root, int value) {
	...
	while (value != temp->value) {	//while temp is not inserting
...
node* BinarySearchTree::_insert_in_non_empty(node* root, int value) {
	if (root == nullptr)
		return new node(value);
